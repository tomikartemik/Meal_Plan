 ...
 */
public abstract class Hilt_FoodRecipeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FoodRecipeFragment() {
    super();
  }

  Hilt_FoodRecipeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FoodRecipeFragment_GeneratedInjector) this.generatedComponent()).injectFoodRecipeFragment(UnsafeCasts.<FoodRecipeFragment>unsafeCast(this));
    }
  }
