 ...
 */
public abstract class Hilt_JokeRecipeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_JokeRecipeFragment() {
    super();
  }

  Hilt_JokeRecipeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((JokeRecipeFragment_GeneratedInjector) this.generatedComponent()).injectJokeRecipeFragment(UnsafeCasts.<JokeRecipeFragment>unsafeCast(this));
    }
  }
