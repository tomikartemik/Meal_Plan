 ...
 */
public abstract class Hilt_RecipeOverviewFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecipeOverviewFragment() {
    super();
  }

  Hilt_RecipeOverviewFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeOverviewFragment_GeneratedInjector) this.generatedComponent()).injectRecipeOverviewFragment(UnsafeCasts.<RecipeOverviewFragment>unsafeCast(this));
    }
  }
