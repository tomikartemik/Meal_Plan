 ...
 */
public abstract class Hilt_RecipeFilterBottomSheetFrag extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecipeFilterBottomSheetFrag() {
    super();
  }

  Hilt_RecipeFilterBottomSheetFrag(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeFilterBottomSheetFrag_GeneratedInjector) this.generatedComponent()).injectRecipeFilterBottomSheetFrag(UnsafeCasts.<RecipeFilterBottomSheetFrag>unsafeCast(this));
    }
  }
