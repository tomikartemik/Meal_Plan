 ...
 */
public abstract class Hilt_FavoriteRecipeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoriteRecipeFragment() {
    super();
  }

  Hilt_FavoriteRecipeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteRecipeFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteRecipeFragment(UnsafeCasts.<FavoriteRecipeFragment>unsafeCast(this));
    }
  }
